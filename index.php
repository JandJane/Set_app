...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src = "js/technical1.js" defer></script>
</head>
<body>
<div id = 'header'>
    <table> <tr>
...
<table id = 'table' style = 'margin-left: 30px'>
    <tr>
        <td colspan='2' width = '230px' align = 'center'>  <!--deleted valign = 'buttom' here -->
    ...
    <tr>
        <td colspan = '2' align = center>
            <img src = "img/clock.gif" height="50" width="50" style = "float: left; margin-left: 30px; margin-top: -10px"> <p id = 'time'> </p>
        </td>
...
<div id="rating">
    ...
    ?>
    <iframe id = "rating_iframe" src = 'classic.php' scrolling="no" width="480" height="480" frameborder = '0'></iframe>
